...
- 喜欢的音乐：日系电音以及关系比较近的JPOP，比如电音部、Tano*C 等，比较喜欢的风格有 Garage、DnB、Progressive、Psy、Eurobeat、Gabber、Makina、UK Hardcore……
- 最近有在慢慢尝试从零开始学习作编曲
...
- 以前主玩 FPS。现在比较少打游戏，只会在新番低潮期偶尔玩玩一些不需要练习的游戏
- 曾经沉迷过《OSU！》，也玩过一些 BMS 在内的其他音游，大概就三四段左右的水平。现已全部退坑，如果一时兴起可能还会休闲地开下 OSU
- 云玩家，偶尔喜欢看一点速通
- 不玩手游

### As a programmer

- 主写 Java 和 Python，其他 JVM 语言也会点以及简单的 js。如果有什么有意义的项目 idea 的话欢迎合作（认识的人限定）
